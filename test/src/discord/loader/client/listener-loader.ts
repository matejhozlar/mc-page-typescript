...
/**
 * Dynamically loads and registers client even listeners from discord/listeners/client folder
 *
 * @param {Client} client - The Discord client instance to register listeners on
 * @param {ListenerDependencies} deps - Dependencies to pass to each listener function
 */
