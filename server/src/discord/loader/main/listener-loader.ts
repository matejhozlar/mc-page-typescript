...
/**
 * Dynamically loads and registers mainBot event listeners from discord/listeners/mainBot folder
 *
 * @param mainBot - The Discord client instance to register listeners to
...
export async function registerClientListeners(
  ...
  const listenersDir = path.join(__dirname, "..", "..", "listeners", "mainBot");
  ...
  for (const file of files) {
    ...
    if (typeof module.default === "function") {
      await module.default(mainBot, deps);
    }
  }
}
